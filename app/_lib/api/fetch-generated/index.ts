 ...
 * Fit AI API
 * API for the Fit AI application
...
export type updateWorkoutSessionResponseError = (updateWorkoutSessionResponse401 | updateWorkoutSessionResponse404 | updateWorkoutSessionResponse500) & {
  headers: Headers;
};
